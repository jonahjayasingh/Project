  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <Text style={styles.header}>🌳 DFS (Depth-First Search) Visualizer</Text>
        <Text style={styles.subtitle}>Preorder Traversal: Root → Left → Right</Text>
        ...
        <View style={styles.controls}>
          ...
          >
            <Text style={styles.buttonText}>▶️ Start DFS</Text>
          </TouchableOpacity>
