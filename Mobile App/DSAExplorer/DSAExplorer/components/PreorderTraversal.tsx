...
// Preorder traversal collecting nodes
const preorderTraversal = (root: TreeNode | null, result: TreeNode[] = []) => {
...
export function PreorderTraversalVisualizer() {
  ...
  const startTraversal = () => {
    ...
    const seq = preorderTraversal(root, []);
    setOrder(seq);
    setCurrentIdx(-1);
    setIsPlaying(true);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <Text style={styles.header}>🌲 Preorder Traversal Visualizer</Text>
        <Text style={styles.subtitle}>Root → Left → Right</Text>
        ...
        <View style={styles.statusContainer}>
          <Text style={styles.status}>
            {currentIdx === -1 ? 'Ready to start preorder traversal' : 
        ...
        {order.length > 0 && (
          <View style={styles.traversalCard}>
            <Text style={styles.traversalTitle}>Preorder Traversal Path:</Text>
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoTitle}>📖 About Preorder Traversal:</Text>
          <Text style={styles.infoText}>
            • 🌳 Order: Root → Left subtree → Right subtree{'\n'}
            • 🎯 Useful for creating a copy of the tree{'\n'}
            • ⚡ Time Complexity: O(n) where n is number of nodes{'\n'}
            • 💾 Space Complexity: O(h) where h is height of tree{'\n'}
            • 📊 Uses: Expression tree evaluation, directory tree traversal{'\n'}
            • 🔍 Algorithm: Visit root, recursively traverse left, recursively traverse right
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
