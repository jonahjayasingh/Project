...
def generate_receipt(data, input_path="static/Receipt.png", output_path=None):
    ...
    try:
        ...
        font_config = {
            'bold': {'name': 'static/font/arialbd.ttf', 'size': 90, 'fallback': 'static/font/arial.ttf'},
            'regular': {'name': 'static/font/arial.ttf', 'size': 60, 'fallback': None}
        }
