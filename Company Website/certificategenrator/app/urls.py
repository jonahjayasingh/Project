...
urlpatterns = [
    ...
    path("genrate_receipt/<int:id>",genrate_receipt, name="genrate_receipt"),
...
website_details =[
    path("websitedetails",website_details,name="website_details"), 
    path("delete_website",delete_website,name="delete_website"),
    path("applicants/<int:id>",applicants,name="applicants"),
    path("export_applicants/<int:id>",export_applicants,name="export_applicants"),
    path("verify_certificate",verify_certificate,name="verify_certificate"),
]

urlpatterns += website_details
